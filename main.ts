...
function criar_banana () {
    banana = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Food)
    tileUtil.createSpritesOnTiles(sprites.builtin.forestTiles0, img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . f f f f f . 
        . . . . . . . . . . f f f f f . 
        . . . . . . . f f f 5 5 5 5 f . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Food)
    for (let bamana of sprites.allOfKind(SpriteKind.Food)) {
        bamana.y += -32
    }
}
...
tileUtil.onMapLoaded(function (tilemap2) {
    tiles.placeOnRandomTile(mySprite, tileUtil.arrow0)
})
...
mapa1 = tilemap`level0`
mapa2 = tilemap`level6`
